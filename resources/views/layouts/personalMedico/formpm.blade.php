...
<!-- Content Header (Page header) -->
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Formulario "Agregar Personal Médico"</h1>
          </div>
          <div class="col-sm-6">
              ...
              <form class="form-horizontal" method="POST">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="telRef_pm" name="telRef_pm" placeholder="Telefono de referencia del Paciente">
                    </div>
                  </div>
