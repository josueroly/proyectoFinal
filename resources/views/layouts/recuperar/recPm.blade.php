        ...
        <div class="col-12">
          ...
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Personal Médico --- Eliminados</h3>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <!--EDITAR-->
                    <td>
                      <form action="{{action('RecuperarController@restMedico', $listado->id)}}" method="POST">
                        {{csrf_field()}}
                        {{ method_field('DELETE') }}
                        <input type="button" class="btn btn-success btn-sm" value="Restaurar" onclick="
                         swal({
                            title: '¿Recuperar Personal medico?',
